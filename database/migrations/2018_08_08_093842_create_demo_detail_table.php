...
class CreateDemoDetailTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('demo_detail', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('demo_id')->comment('案例ID')->nullable();
            $table->string('qrcode_url')->comment('二维码地址');
            $table->string('img1')->comment('图片1');
            $table->string('img2')->comment('图片2');
            $table->string('img3')->comment('图片3');
            $table->string('img4')->comment('图片4');
            $table->string('img5')->comment('图片5');
